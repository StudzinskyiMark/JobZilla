...
export default function SignInPage() {
	return (
		<div className="flex items-center justify-center bg-gray-100 min-h-[calc(100vh-6rem)] px-4">
			<div className="bg-white rounded-md shadow-md w-full max-w-md space-y-6 p-4">
				...
				<button
					...
					<svg
						...
						viewBox="-2 -2 24 24"
						className="h-5 w-5 fill-current mx-2">
						<path
							fill="currentColor"
							fillRule="evenodd"
				...
				<button
					...
					className="w-full flex items-center justify-center bg-gray-200 text-gray-950 hover:bg-gray-300 rounded-md p-2 text-sm">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						viewBox="-0.5 0 48 48"
						className="h-5 w-5 fill-current mx-2">
